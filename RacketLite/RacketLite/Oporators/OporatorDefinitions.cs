...
namespace RacketLite.Oporators
{
    public static class OporatorDefinitions
    {
        public static readonly Dictionary<string, RacketOporator> RacketOporatorMap = new Dictionary<string, RacketOporator>()
        {
            ...
            { "current-seconds", new RacketOporator(RacketOporatorType.CurrentSeconds, 0, 0, RacketOperandType.Any) },
            ...
            { "modulo", new RacketOporator(RacketOporatorType.Modulo, 2, 2, RacketOperandType.Natural) },
            ...
            { "remainder", new RacketOporator(RacketOporatorType.Remainder, 2, 2, RacketOperandType.Natural) },
